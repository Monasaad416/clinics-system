...
class GeneralFinancialReportBranch extends Component
{
    // use WithPagination;
    public $branch_id;
    ...
    public function render()
    {
        ...
        })->where('branch_id',auth()->user()->branch_id)->where('status', 'completed')->sum('reservation_price');
        ...
        })->where('branch_id',auth()->user()->branch_id)->sum('final_price');
        ...
        })->where('branch_id',auth()->user()->branch_id)->whereNotNull('doctor_id')->sum('amount');
        ...
        })->where('branch_id',auth()->user()->branch_id)->whereNotNull('user_id')->sum('amount');
        ...
        })->where('branch_id',auth()->user()->branch_id)->whereNull('doctor_id')->whereNull('user_id')->sum('amount');
        ...
        return view('livewire.general-financial-report-branch', compact('reservations','serviceBookings','doctorsProfits','employeesProfits','companiesProfits','clinicsProfits','payments','doctorsPayments','employeesPayments','otherPayments','branches','specialists'));
    }
