...
class FinancialDistributionBranch extends Component
{
    // use WithPagination;
    public $branch_id;
    ...
    public function render()
    {
        ...
        })->where('branch_id',auth()->user()->branch_id)->where('status', 'completed')->paginate(20);
        ...
        })->where('branch_id',auth()->user()->branch_id)->where('notes','ارباح كشف')->sum('amount');
        ...
        return view('livewire.financial-distribution-branch', compact('reservations','clinicsProfits','doctorsProfits','companiesProfits','branches','specialists'));
    }
