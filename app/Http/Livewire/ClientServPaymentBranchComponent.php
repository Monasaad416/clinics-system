...
use App\Exports\ClientServPaymentBranchExport;

class ClientServPaymentBranchComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.client-serv-payment-branch-component',compact('clientsServpayments'));
    }
    ...
    public function exportClientServices()
    {
        ...
        return Excel::download(new ClientServPaymentBranchExport( $from_date,$to_date,$branch_id,$sub_specialist_id,$specialist_id,$doctor_id), 'clients-reservations-payments
        .xlsx');
    }
