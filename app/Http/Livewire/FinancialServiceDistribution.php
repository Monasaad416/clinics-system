...
class FinancialServiceDistribution extends Component
{
    // use WithPagination;
    public $branch_id;
    ...
    public function render()
    {
        ...
        })->where('notes','ارباح خدمة')->sum('amount');
        ...
        return view('livewire.financial-service-distribution', compact('serviceBookings','branches','specialists','doctorsProfits','employeesProfits','companiesProfits','clinicsProfits','doctorsPayments','employeesPayments','otherPayments'));
    }
