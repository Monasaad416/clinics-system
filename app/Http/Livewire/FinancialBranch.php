...
use App\Exports\ReservationsBranchExport;
...
class FinancialBranch extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.financial-branch', compact('reservations','doctors','fees','payments','net','totalInsurance','branches','netServices','specialists'));
    }
    ...
    public function reservationsBranch()
    {
        ...
        return Excel::download(new ReservationsBranchExport( $from_date,$to_date,$branch_id,$specialist_id,$doctor_id), 'reservations-branch.xlsx');
    }
