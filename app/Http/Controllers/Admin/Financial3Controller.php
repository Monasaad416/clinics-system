...
class Financial3Controller extends Controller
{
    
    public function index(Request $request){
        $branches = Branch::where('id',3)->first();
        $fees = 0;
        $insurance = 0;
        $net = 0;
        ...
        $payments= Salary::where('branch_id',3)->sum('amount');
        ...
        return view('admin.pages.financial-3.index', compact('reservations','fees','payments','net','totalInsurance','branches','netServices'));
    }
      ...
      //return dd($request->all());
        ...
        // return redirect()->to($request->fullUrlWithQuery([]));
                ...
                $branch = Branch::where('id',3)->first();
                 ...
                 return view('admin.pages.financial-3.search', compact('reservations','fees','payments','net','insurance','branches','branch','from','to','netServices'));
