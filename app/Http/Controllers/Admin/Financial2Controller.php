...
class Financial2Controller extends Controller
{
    ...
    public function index(Request $request){
        $branches = Branch::where('id',2)->first();
        $fees = 0;
        $insurance = 0;
        $net = 0;
        ...
        $payments= Salary::where('branch_id',2)->sum('amount');
        ...
        return view('admin.pages.financial-2.index', compact('reservations','fees','payments','net','totalInsurance','branches','netServices'));
    }
      ...
      //return dd($request->all());
        ...
        // return redirect()->to($request->fullUrlWithQuery([]));
                ...
                $branch = Branch::where('id',2)->first();
                 ...
                 return view('admin.pages.financial-2.search', compact('reservations','fees','payments','net','insurance','branches','branch','from','to','netServices'));
