						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">قائمة سندات القبض لفرع {{ auth()->user()->branch->name_ar }}</h4>
                                        <button class="btn btn-primary"><a class="x-small text-white" wire:click="exportClientServicesBranch" >تصدير إلي إكسيل</a></button>
								</div>
								...
								<div class="table-responsive">
									<table class="table table-hover mb-0 text-md-nowrap">
										...
										<tbody>
											...
											@endphp --}}
                                            @foreach ($clientspayments as $payment )
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('admin.clients_payments.edit',$payment->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true" title="تحديث السند"><i class="fa fa-edit text-white" aria-hidden="true"></i></a>
                                                    </td>
