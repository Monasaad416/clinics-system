                ...
                <div class="card overflow-hidden sales-card bg-primary-gradient">
                    <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    <h4 class="tx-20 font-weight-bold mb-1 text-white" id="total">{{ number_format($fees,2) }} جنيه</h4>
                                </div>
		...
		<div class="card">
			<div class="card-header pb-0">
				<div class="d-flex justify-content-between">
				 ...
				 <button class="btn btn-primary"><a class="x-small text-white" wire:click="reservationsBranch" >تصدير إلي إكسيل</a></button>
			</div>
			<div class="card-body">
				<div>
                    <div class="row my-5">
