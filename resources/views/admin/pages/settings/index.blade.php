										...
										<tbody>
                                            @foreach ($branches as $branch )
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_branch{{ $branch->id }}" title="حذف الفرع"><i class="fa fa-trash"></i></button></td>
                                                                       <!-- Delete Modal -->
                                                        <form action="{{route('admin.branches.destroy',$branch)}}" method="POST">
                                                            <div class="modal fade" id="delete_branch{{$branch->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <h5 class="modal-title" id="exampleModalLabel">حذف الفرع من قائمة الأفرع</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <p>هل انت متأكد من حذف الفرع   {{$branch->name_ar}}</p>
