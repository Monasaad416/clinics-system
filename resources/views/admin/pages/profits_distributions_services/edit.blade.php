...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">تعديل سند قبض من للعميل للحجز {{ $payment->reservation->number }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ أذونات القبض</span>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <option value="">إختر الخدمات الإضافية</option>
