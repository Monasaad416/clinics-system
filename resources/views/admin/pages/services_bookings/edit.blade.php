...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">تحديث حجز خدمة رقم {{ $serviceBooking->number }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ حجز الخدمات</span>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        ...
                        @php
                            ...
                            $employees = App\Models\User::where('branch_id',$serviceBooking->branch_id)->pluck('name', 'id');
                            $subSpecialists = App\Models\SubSpecialist::where('specialist_id',$serviceBooking->specialist_id)->pluck('name_ar', 'id') ;
                            $doctors = App\Models\Doctor::where('branch_id',$serviceBooking->branch_id)->where('specialist_id',$serviceBooking->specialist_id)->pluck('name_ar', 'id');
                        ...
                        @include('inc.errors')  
                        {!! Form::model($serviceBooking,[
                            'route' => ['admin.services_bookings.update',$serviceBooking->id],
                            ])
                        !!}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                {!! Form::label('name','إسم العميل ')!!}
                                    {!!Form::text('name', $serviceBooking->client->name,[
                                        'class' => 'form-control  mt-1 mb-3',
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!!Form::text('phone', $serviceBooking->client->phone,[
                                        'class' => 'form-control  mt-1 mb-3',
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!!Form::date('date_of_birth', $serviceBooking->client->date_of_birth,[
                                        'class' => 'form-control  mt-1 mb-3',
                            ...
                            <div class="col-md-6 my-4 my-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="user_type" id="user_type">
                                        <option value="doctor" {{$serviceBooking->doctor_id ? 'selected' : '' }} >طبيب</option>
                                         <option value="employee" {{$serviceBooking->user_id ? 'selected' : '' }} >موظف</option>
                                ...
                                <div class="col-md-6 my-4 my-4 doctor">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('doctor_id', $doctors, $serviceBooking->doctor_id ?? null,
                                        ['class' => 'form-control  mt-1 mb-3',
                                ...
                                <div class="col-md-6 my-4 my-4 employee">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('employee_id', $employees, $serviceBooking->user_id ?? null ,
                                        ['class' => 'form-control  mt-1 mb-3',
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 my-5">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="service_price" name="service_price" step="any" value={{$serviceBooking->service_price}} placeholder="أدخل سعر الخدمة">
                                </div>
                            </div>
                        </div>
                           ...
                           <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!!Form::text('insurance', $serviceBooking->insurance,[
                                            'class' => 'form-control  mt-1 mb-3',
                                ...
                                <div class="col-md-6">
                                    ...
                                    {!!Form::label('name', 'النسبة المئوية لتحمل التأمين % ')!!}
                                        {!!Form::number('insurance_percentage', $serviceBooking->percentage,[
                                            'class' => 'form-control  mt-1 mb-3',
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::number('discount', $serviceBooking->discount ,
                                        ['class' => 'form-control  mt-1 mb-3',
...
<script>
  $(document).ready(function () {
         const selectedOptionVal = $('#user_type option:selected').val();
        if(selectedOptionVal == 'doctor'){
            $('.doctor').show();
            $('.employee').hide();
        } else {
            $('.doctor').hide();
...
<script>
    ...
    // })
        ...
        $('#service_price').on('keyup',function(){
            ...
            $('#total').val(totalPrice -  discount - insurance_discount);
            ...
            const totalPrice = $('#service_price').val();
            $('#discount, #insurancePercentage').on('keyup', function() {
                const discount = parseFloat($('#discount').val()) || 0;
                const insurance_percentage = parseFloat($('#insurancePercentage').val()) || 0;
                const insurance_discount = insurance_percentage * totalPrice /100;
                console.log(insurance_percentage);
