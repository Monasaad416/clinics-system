				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
                            ...
                            @if(auth()->user()->roles_name == ["reception"])
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										...
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">لديك {{ auth()->user()->notifications->count() }} إشعارات غير مقرؤة</p>
									</div>
									<div class="main-notification-list Notification-scroll">
										@foreach (auth()->user()->notifications as $notification )
											<a class="d-flex p-3 border-bottom" href="{{ route('admin.reservations.index')}}">
									...
									<div class="dropdown-footer">
										<a href="{{route('admin.all.notifications')}}">VIEW ALL</a>
									</div>
								</div>
							</div>
                            @endif
